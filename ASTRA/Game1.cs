...
public class Game1 : Game
{
    ...
    /// </summary>
    private string[] requiredTextures = { "blank", "button", "editedAstronaut", "astralogo", "blackoverlay", "directionTriangle", "tile", "hammer", "Wall1", "Wall2", "Wall(front)", "Barrel", "brokenPanel"};
